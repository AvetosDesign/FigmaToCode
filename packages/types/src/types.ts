...
// Design Bundle schema. designs[] and DesignNode below are the runtime
// types the serializer in packages/backend/src/designBundle/ produces —
// keep them in sync with that code when either changes.
